<?php
    ...
    // menerima gambar yang di upload
    $image = uploadImage('upload/karyawan');
    if ( !$image ) {
      return false;
    }

    // melakukan cek username apakan sudah ada data yang sama
    ...
    // Konfirmasi password yang dimasukan
	...
	// Enskripsi data passwrod agar aman
    $password = password_hash($password, PASSWORD_DEFAULT);

    // Insert data user ka tabel karyawane
