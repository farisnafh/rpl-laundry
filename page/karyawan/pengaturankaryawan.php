<?php
	...
	// mengambil seluruh data dari tabel karywan berdasarkan id
	...
	if( isset($_POST['submit'])) {
		...
		// Konfirmasi password yang diinputkan
		...
		// melakukan proses enskripsi pada password baru, agar aman	
		$password_baru = password_hash($password_baru, PASSWORD_DEFAULT);

		// Melakukan update data karyawan berupa password dan role
